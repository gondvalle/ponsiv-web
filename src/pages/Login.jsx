...
import { Lock, User, ArrowRight, AlertCircle, ArrowLeft, Sparkles } from 'lucide-react';
                ...
                >
                    <div className="p-8 sm:p-10">
                        ...
                        <div className="flex flex-col items-center mb-10">
                            <motion.div
                                ...
                                className="mb-6"
                            >
                                <img src="/assets/logos/Ponsiv.png" alt="Ponsiv" className="h-12 w-auto" />
                            </motion.div>

                            <div className="text-center">
                                <h2 className="text-2xl md:text-3xl font-semibold text-primary mb-2 tracking-tight">Portal de Marcas</h2>
                                <p className="text-secondary text-sm md:text-base">Inicia sesión para gestionar tu marca</p>
                            </div>
                        </div>
                    ...
                    <div className="px-8 py-6 bg-gradient-to-b from-secondary-background to-zinc-50 border-t border-zinc-100 text-center">
                        <p className="text-sm text-secondary">
                            ¿No tienes cuenta? <Link to="/register" className="font-semibold text-accent hover:text-black transition-colors">Regístrate aquí</Link>
                        </p>
                    </div>
                </motion.div>
